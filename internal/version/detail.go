...
// This file was generated by robots at 2022-07-16 20:39:34.415771 -0500 CDT m=+0.061965793
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "git-mob",
		BuildDate:            "2022-07-16 20:39:34.415771 -0500 CDT m=+0.061965793",
        CoreVersion:          "0.3.0",
		GitBranch:            "32-improve-install-story",
		GitCommit:            "e5f64d9",
		GitCommitSummary:     "build: enable preview of release notes",
		GitDirty:             true,
		GitDirtyHasModified:  true,
		GitDirtyHasStaged:    false,
		GitDirtyHasUntracked: false,
		Version:              "0.3.0-alpha+e5f64d9.32-improve-install-story.dirty",
	}
