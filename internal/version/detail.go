...
// This file was generated by robots at 2022-07-19 09:49:54.217622 -0500 CDT m=+0.051707126
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "git-mob",
		BuildDate:            "2022-07-19 09:49:54.217622 -0500 CDT m=+0.051707126",
        CoreVersion:          "0.4.1",
		GitBranch:            "init-all",
		GitCommit:            "c69ccbd",
		GitCommitSummary:     "feat: git mob init-all [base-path]",
		GitDirty:             true,
		GitDirtyHasModified:  true,
		GitDirtyHasStaged:    true,
		GitDirtyHasUntracked: false,
		Version:              "0.4.1-alpha+c69ccbd.init-all.dirty",
	}
