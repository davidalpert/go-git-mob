...
// This file was generated by robots at 2022-08-06 10:30:03.36856 -0500 CDT m=+0.058934085
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "git-mob",
		BuildDate:            "2022-08-06 10:30:03.36856 -0500 CDT m=+0.058934085",
        CoreVersion:          "0.5.1",
		GitBranch:            "main",
		GitCommit:            "f5536c2",
		GitCommitSummary:     "build: build only once",
		GitDirty:             false,
		GitDirtyHasModified:  false,
		GitDirtyHasStaged:    false,
		GitDirtyHasUntracked: false,
		Version:              "0.5.1+f5536c2",
	}
