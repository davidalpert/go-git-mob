...
// This file was generated by robots at 2022-08-08 19:05:58.295191 -0500 CDT m=+0.063878626
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "git-mob",
		BuildDate:            "2022-08-08 19:05:58.295191 -0500 CDT m=+0.063878626",
		CoreVersion:          "0.6.0",
		GitBranch:            "mob/update-parity",
		GitCommit:            "3ad18a5",
		GitCommitSummary:     "refactor: update to latest git-mob",
		GitDirty:             true,
		GitDirtyHasModified:  true,
		GitDirtyHasStaged:    true,
		GitDirtyHasUntracked: false,
		Version:              "0.6.0-alpha+3ad18a5.mob/update-parity.dirty",
	}
